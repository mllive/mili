...
public class BaseDaoImpl<T> implements BaseDaoI<T> {
	...
	public Map<String, Object> queryMap(String sql, List<Object> param) {
		List<Map<String, Object>> list = queryList(sql, param);
	...
	public List<Map<String, Object>> queryList(String sql, List<Object> param) {
	...
	public Long countSql(String sql, List<Object> param) {
		...
		String result = String.valueOf(q.uniqueResult());
		return Long.valueOf(result);
	}

	public List<Map<String, Object>> queryList(String sql, int page, int rows, List<Object> param) {
		Query q = this.getCurrentSession().createSQLQuery(sql);
		q.setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP);
		if (param != null && param.size() > 0) {
			for (int i = 0; i < param.size(); i++) {
